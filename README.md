...
Some modules need to be compiled, requiring additional dependencies.  Also, installing
nvm on windows is a bit more tricky.  We have included these
[advanced Windows installation steps](windows-advanced-install.md)
in a separate file to address later, or now if you're feeling ambitious.
